...
import { X, Send, PhoneCall, Gift, CheckCircle2, Activity, Calendar, Clock, ShoppingCart, LogIn, Monitor } from 'lucide-react';
...
export default function CustomerModal({ customer, onClose }) {
  ...
  const handleAction = (actionName) => {
    setToastMessage(`Action Triggered: "${actionName}" for ${customer.user_id}`);
    setTimeout(() => {
      ...
      <div className="glass-card animate-fade-in" style={{
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '20px' }}>
          <div>
            ...
            <p style={{ fontSize: '0.85rem', color: '#94a3b8' }}>Comprehensive Customer Profile & Activity Analytics</p>
          </div>
          <button
            onClick={onClose}
            style={{
        ...
        <h3 style={{ fontSize: '1rem', fontWeight: 600, color: '#f8fafc', marginBottom: '14px' }}>Activity & Engagement Metrics</h3>
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(130px, 1fr))', gap: '12px', marginBottom: '24px' }}>
          ...
          <div style={{ background: 'rgba(30, 41, 59, 0.5)', padding: '12px', borderRadius: '10px', border: '1px solid var(--border-color)' }}>
            ...
            <div style={{ fontSize: '0.7rem', color: '#64748b' }}>days logged in</div>
          </div>
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '12px' }}>
            ...
            <span style={{ fontSize: '0.75rem', color: '#94a3b8', fontStyle: 'italic' }}>Demo Controls</span>
          </div>

          <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
            <button
              onClick={() => handleAction("Send Personalized 20% Discount Offer")}
              style={{
                display: 'flex',
                alignItems: 'center',
            ...
            >
              <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                ...
                <span>Send Personalized Retention Offer</span>
              </div>
              <span style={{ fontSize: '0.75rem', opacity: 0.8 }}>Trigger Email</span>
            </button>

            <button
              onClick={() => handleAction("Dispatch Re-engagement Push Notification")}
              style={{
                display: 'flex',
                alignItems: 'center',
                justifyContent: 'space-between',
            ...
            >
              <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                ...
                <span>Send Re-engagement Notification</span>
              </div>
              <span style={{ fontSize: '0.75rem', opacity: 0.8 }}>Push Alert</span>
            </button>

            <button
              onClick={() => handleAction("Escalate to VIP Retention Specialist")}
              style={{
                display: 'flex',
                alignItems: 'center',
                justifyContent: 'space-between',
            ...
            >
              <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
                ...
                <span>Contact Customer Support / Account Manager</span>
              </div>
              <span style={{ fontSize: '0.75rem', opacity: 0.8 }}>Schedule Call</span>
            </button>
          </div>
        </div>
